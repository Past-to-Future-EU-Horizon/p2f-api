...
from p2f_api.web import keywords
...
app.include_router(seasonality.router_ds)
app.include_router(seasonality.router_rec)
app.include_router(harm_ds_timecov.router)
