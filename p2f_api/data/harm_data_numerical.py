...
class harmonized_int_confidence(baseSQL):
    ...
    __table_args__ = (
        PrimaryKeyConstraint("pk_harm_num", "fk_data_type", name="pk_fk_hnic_unique"),
        {"postgresql_partition_by": "LIST(fk_data_type)"},
    )
...
class harmonized_int(baseSQL):
    ...
    __table_args__ = (
        PrimaryKeyConstraint("pk_harm_num", "fk_data_type", name="pk_fk_hni_unique"),
        {"postgresql_partition_by": "LIST(fk_data_type)"},
    )
    pk_harm_num: Mapped[UUID] = mapped_column(Uuid, default=func.gen_random_uuid())
    value: Mapped[int] = mapped_column(BigInteger)
...
class harmonized_float_confidence(baseSQL):
    ...
    __table_args__ = (
        PrimaryKeyConstraint("pk_harm_num", "fk_data_type", name="pk_fk_hnfc_unique"),
        {"postgresql_partition_by": "LIST(fk_data_type)"},
    )
    pk_harm_num: Mapped[UUID] = mapped_column(Uuid, default=func.gen_random_uuid())
...
class harmonized_float(baseSQL):
    ...
    __table_args__ = (
        PrimaryKeyConstraint("pk_harm_num", "fk_data_type", name="pk_fk_hnf_unique"),
        {"postgresql_partition_by": "LIST(fk_data_type)"},
    )
    pk_harm_num: Mapped[UUID] = mapped_column(Uuid, default=func.gen_random_uuid())
    value: Mapped[float] = mapped_column(Double)
...
class harmonized_numeric_id_map(baseSQL):
    ...
    fk_harm_num: Mapped[UUID] = mapped_column(
