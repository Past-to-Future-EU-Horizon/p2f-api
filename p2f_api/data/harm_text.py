...
class harm_text(baseSQL):
    ...
    text_id: Mapped[UUID] = mapped_column(Uuid, unique=True, nullable=False, default=func.gen_random_uuid())
    text_content: Mapped[str] = mapped_column(Text, nullable=False)
    text_data_type: Mapped[str] = mapped_column(ForeignKey("p2f_harm_text_data_types.text_data_type_id"))
