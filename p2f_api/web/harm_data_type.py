...
@router.post("/{datatype_id}/assign/{dataset_id}", operation_id="datatype_dataset-assign")
...
@router.delete("/{datatype_id}/remove/{dataset_id}", operation_id="datatype_dataset-remove")
